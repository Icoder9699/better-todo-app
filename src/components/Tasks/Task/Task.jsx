...
export default function Task({id, completed, text, list, onRemove, editTask, checkTask}) {
    return (
        <div key={id} className="tasks__item">
            <div className="checked" >
                <input 
                    onClick={() => checkTask(list.id, {id, completed})} 
                    id={`task_${id}`} 
                    type="checkbox" checked={completed} readOnly
                />
            ...
            <div className="tasks__item-actions">
                <div onClick={() => editTask(list.id, {text, id})}>
                    <svg
                        width="15"
                        height="15"
                        viewBox="0 0 15 15"
